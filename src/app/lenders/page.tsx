            ...
            {[
              {
                ...
                desc: 'Every disbursement passes 7 server-side checks simultaneously before funds move.',
              },
              {
                icon: BarChart3,
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <ol className="space-y-6">
            {[
              ...
              'You review and approve each milestone. The 7-condition gate enforces your rules.',
      ...
      <section className="border-t border-vektrum-border bg-vektrum-surface py-20 sm:py-24">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="mt-4 mx-auto max-w-md text-[15px] text-vektrum-muted">
            Standalone projects start free. Institutional portfolios get dedicated onboarding.
          </p>
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-4">
            <Link
              href="/auth/signup"
