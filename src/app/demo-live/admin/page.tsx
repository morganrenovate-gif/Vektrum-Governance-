      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 space-y-8">
        ...
        <section id="open-disputes">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-[#111827] p-4 flex items-start justify-between gap-4" style={{ boxShadow: '0 8px 32px rgba(0,0,0,0.35), 0 0 0 1px rgba(255,255,255,0.03)' }}>
            ...
            <Link href="/demo-live/deal/harbor-dispute?from=admin" className="bg-vektrum-amber/20 border border-vektrum-amber/30 text-vektrum-amber px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap hover:bg-vektrum-amber/30 transition-all">
              View Dispute →
            </Link>
          </div>
        </section>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  <tr key={d.slug} className="border-t border-white/[0.06] hover:bg-white/[0.03] transition-colors">
                    <td className="px-4 py-3"><Link href={`/demo-live/deal/${d.slug}?from=admin`} className="text-vektrum-blue hover:underline font-medium">{d.name}</Link></td>
