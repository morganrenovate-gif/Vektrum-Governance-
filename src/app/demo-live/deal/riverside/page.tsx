                    ...
                    {status === 'ready_for_review' && (
                      <>
                        ...
                        <button
                          ...
                          className="border border-vektrum-blue/40 text-blue-300 bg-surface-3 hover:bg-vektrum-blue/[0.12] px-3 py-1.5 rounded-lg text-sm font-medium flex items-center gap-1.5 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="text-white/65 hover:text-blue-300 transition-colors"
