    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(10,15,28,1) 1px, transparent 1px), linear-gradient(90deg, rgba(10,15,28,1) 1px, transparent 1px)",
        ...
        <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 pt-24 pb-20 sm:pt-32 sm:pb-28">
          ...
          {/* Headline */}
          <h1 className="animate-fade-in text-center text-4xl font-bold tracking-[-0.035em] text-[#0A0F1C] sm:text-5xl lg:text-[3.5rem] lg:leading-[1.1] text-balance">
            Funds release when
          ...
          {/* Subheadline */}
          <p className="animate-fade-in-delay mx-auto mt-6 max-w-lg text-center text-[17px] leading-relaxed text-gray-500">
          ...
          <div className="animate-fade-in-delay-2 mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-4">
            <Link
              href="/auth/signup"
              className="group inline-flex min-h-[48px] items-center justify-center gap-2 rounded-xl bg-[#0A0F1C] px-7 py-3 text-[14px] font-semibold text-white shadow-lg shadow-gray-900/10 hover:bg-[#1E293B] transition-all"
            >
              Start a deal
              <ArrowRight
                size={15}
            ...
            <Link
              href="/auth/login"
              className="inline-flex min-h-[48px] items-center justify-center rounded-xl border border-gray-200 bg-white px-7 py-3 text-[14px] font-semibold text-gray-700 shadow-sm hover:bg-gray-50 hover:border-gray-300 transition-all"
            >
              Sign in
            </Link>
          </div>
      ...
      <section className="border-y border-gray-200/80 bg-white">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-10">
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 sm:gap-0 sm:divide-x sm:divide-gray-100">
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center sm:px-6">
                <span className="text-2xl font-bold tracking-[-0.02em] text-[#0A0F1C] font-numeric sm:text-3xl">
                  {stat.value}
                </span>
                <span className="mt-1.5 text-[13px] leading-snug text-gray-500">
                  {stat.label}
                </span>
      ...
      <section className="bg-[#FAFBFC] py-20 sm:py-28">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-16">
            ...
            <h2 className="mt-3 text-2xl font-bold tracking-[-0.025em] text-[#0A0F1C] sm:text-3xl">
              Protected at every step
            </h2>
            <p className="mt-3 mx-auto max-w-md text-[15px] text-gray-500">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.step}
                className="group relative rounded-2xl border border-gray-200/80 bg-white p-6 hover:border-gray-300 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300"
              >
                <div className="flex items-center gap-3 mb-4">
                  <span className="font-mono text-[12px] font-semibold text-gray-300">
                    {item.step}
                  </span>
                  <div className="h-px flex-1 bg-gray-100" />
                  <item.icon size={18} className="text-gray-400 group-hover:text-[#0A0F1C] transition-colors" />
                </div>
                <h3 className="text-[15px] font-semibold text-[#0A0F1C] tracking-[-0.01em]">
                  {item.title}
                </h3>
      ...
      <section className="bg-[#0A0F1C] py-20 sm:py-28">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {/* Card 1 */}
            <div className="rounded-2xl border border-[#1E293B] bg-[#111827] p-8 hover:border-[#334155] transition-colors">
            ...
            {/* Card 2 */}
            <div className="rounded-2xl border border-[#1E293B] bg-[#111827] p-8 hover:border-[#334155] transition-colors">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500/10 mb-5">
            ...
            {/* Card 3 */}
            <div className="rounded-2xl border border-[#1E293B] bg-[#111827] p-8 hover:border-[#334155] transition-colors">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/10 mb-5">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid gap-6 sm:grid-cols-2 max-w-3xl mx-auto">
            ...
            <div className="rounded-2xl border border-gray-200/80 bg-white p-8">
              <span className="text-[11px] font-semibold uppercase tracking-[0.1em] text-blue-500">
                Contractors
              </span>
              <h3 className="mt-3 text-lg font-semibold text-[#0A0F1C] tracking-[-0.01em]">
              ...
              <ul className="mt-5 flex flex-col gap-3">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2.5">
                    ...
                    <span className="text-[13px] leading-relaxed text-gray-600">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {/* Funders */}
            <div className="rounded-2xl border border-gray-200/80 bg-white p-8">
              <span className="text-[11px] font-semibold uppercase tracking-[0.1em] text-amber-500">
                Funders &amp; Lenders
              </span>
              <h3 className="mt-3 text-lg font-semibold text-[#0A0F1C] tracking-[-0.01em]">
      ...
      {/* ─── CTA ───────────────────────────────────────────────────────────── */}
      <section className="border-t border-gray-200/80 bg-white py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <h2 className="text-2xl font-bold tracking-[-0.025em] text-[#0A0F1C] sm:text-3xl text-balance">
            Stop losing money to broken payment processes
          </h2>
          <p className="mt-4 mx-auto max-w-md text-[15px] text-gray-500">
