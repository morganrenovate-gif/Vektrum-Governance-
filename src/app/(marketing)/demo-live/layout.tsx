...
// Demo-live pages use client-side state (DemoResetButton uses useSearchParams,
// useDemoActivityLog, etc.) — opt out of static prerender to avoid the
// missing-Suspense build error. The marketing tree above this layout still
// stays cacheable; only this subtree opts back in to dynamic.
