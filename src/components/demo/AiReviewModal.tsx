    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true">
      ...
      <div className="relative max-w-md w-full mx-4 rounded-2xl bg-white shadow-2xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-semibold text-gray-900">AI Draw Review</h2>
        ...
        {phase === 'loading' ? (
          <div className="py-8 text-center">
            ...
            <p className="text-sm font-medium text-gray-700 mb-4">Vektrum AI is reviewing draw request...</p>
            <div className="space-y-2 text-left max-w-xs mx-auto mb-6">
              {step1 && (
                <p className="text-xs text-gray-500 animate-fade-in">• Analyzing invoice documentation...</p>
              )}
              {step2 && (
                <p className="text-xs text-gray-500 animate-fade-in">• Cross-referencing against approved scope...</p>
              )}
              {step3 && (
                <p className="text-xs text-gray-500 animate-fade-in">• Generating risk assessment...</p>
              )}
            </div>
            <div className="h-2 rounded-full bg-gray-100 overflow-hidden max-w-xs mx-auto">
              <div
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-5">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-700">82/100</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">Risk</p>
                <span className="inline-flex items-center rounded-full bg-green-100 text-green-700 px-3 py-1 text-sm font-medium mt-1">
                  Low
                </span>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">Result</p>
                <p className="text-lg font-semibold text-green-600 mt-1">✓ Pass</p>
              </div>
            </div>
